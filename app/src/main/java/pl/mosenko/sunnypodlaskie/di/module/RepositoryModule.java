...
public class RepositoryModule {
    ...
    @Provides
    @Singleton
    public WeatherDataRepository provideWeatherDataRepository(RxWeatherDataAPI rxWeatherDataAPI, WeatherDataEntityDAO weatherDataEntityDAO, WeatherConditionEntityDAO weatherConditionEntities) {
        return new WeatherDataRepository(rxWeatherDataAPI, weatherDataEntityDAO, weatherConditionEntities);
    }
}
